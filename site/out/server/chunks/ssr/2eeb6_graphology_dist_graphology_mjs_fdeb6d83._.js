module.exports = [
"[project]/devlinux/littletuna4.github.io/site/node_modules/.pnpm/graphology@0.26.0_graphology-types@0.24.8/node_modules/graphology/dist/graphology.mjs [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
 ...
 */ function mergeEdge(graph, name, mustGenerateKey, undirected, edge, source, target, attributes, asUpdater) {
    ...
    if (attributes) {
        if (asUpdater) {
            ...
            if (!isPlainObject(attributes)) throw new InvalidArgumentsGraphError(`Graph.${name}: invalid attributes. Expecting an object but got "${attributes}"`);
        }
    }
    // Coercion of source & target:
    source = '' + source;
 ...
 */ class Graph extends __TURBOPACK__imported__module__$5b$externals$5d2f$events__$5b$external$5d$__$28$events$2c$__cjs$29$__["EventEmitter"] {
    constructor(options){
        super();
        //-- Solving options
...
//# sourceMappingURL=2eeb6_graphology_dist_graphology_mjs_fdeb6d83._.js.map