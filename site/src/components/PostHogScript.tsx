 ...
 * - Load PostHog from CDN and initialize with configuration
 * - Use the exact snippet format provided
 * - Initialize PostHog with API key, host, defaults, and person_profiles setting
 */
...
export function PostHogScript(): React.JSX.Element {
  return (
    <Script
      id="posthog-init"
