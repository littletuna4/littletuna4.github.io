import bomRadarImage from './images_bris_128_202504291340.png';
...
<Image src={bomRadarImage} alt="BOM Radar Image - Brisbane 128km Coverage" className="max-w-full h-auto rounded-lg shadow-sm mb-4" />
