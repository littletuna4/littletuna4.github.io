...
import simplen8nImage from './simplen8n.png';
...
<Image src={simplen8nImage} alt="N8N Workflow" className="max-w-full h-auto rounded-lg shadow-sm mb-4" />

## Sequence Diagram

<Image src={sequenceImage} alt="Sequence Diagram" className="max-w-full h-auto rounded-lg shadow-sm mb-4" />

## Architecture

<Image src={architectureImage} alt="Architecture Diagram" className="max-w-full h-auto rounded-lg shadow-sm mb-4" />
