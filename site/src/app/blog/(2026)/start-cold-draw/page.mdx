...
<Image src={graphImage} alt="Obsidian Graph" className="max-w-full h-auto rounded-lg shadow-sm mb-4" />
...
<Image src={adminDeskImage} alt="Admin desk: event calendar and management quicklinks" className="max-w-full h-auto rounded-lg shadow-sm mb-4" />
...
<Image src={adminSendPanelImage} alt="Admin send panel: draft message from template with invite link and event details" className="max-w-full h-auto rounded-lg shadow-sm mb-4" />
...
<Image src={invitePageImage} alt="Personalised invite page with unique URL" className="max-w-full h-auto rounded-lg shadow-sm mb-4" />

- Invitee should receive a personalised text.
- Invitee should be able to RSVP at link.

<Image src={inviteResponseFormImage} alt="Invitee RSVP and response form" className="max-w-full h-auto rounded-lg shadow-sm mb-4" />
